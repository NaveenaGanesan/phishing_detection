...
dataset = {
    ...
    "4": {"filename": "all_url.csv", "excess_path":"Phishing_URL_dataset/","label_encode_on": "type", "feature_extraction_on": "url"},
}
...
if dataset_details["excess_path"]:
...
df[dataset_details["label_encode_on"]] = df[dataset_details["label_encode_on"]].str.lower()
